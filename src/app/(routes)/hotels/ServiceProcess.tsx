...
import { FiMessageCircle, FiSearch, FiCheckSquare, FiSend } from "react-icons/fi";
  ...
  const steps = [
    {
      ...
      description: "Tell us your destination, dates, budget, and what you're looking for in a hotel.",
    ...
    },
    {
      ...
      description: "Our experts search across multiple platforms to find the best options matching your needs.",
    ...
    },
    {
      ...
      description: "We present you with carefully curated options. You choose what works best for you.",
      color: "from-amber-500 to-orange-500",
    },
    {
      icon: <FiSend className="w-8 h-8" />,
      number: "04",
      title: "We Complete Your Booking",
      description: "Once approved, we handle the reservation and send you all confirmation details.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Four simple steps to your perfect hotel stay
          </p>
        </motion.div>
