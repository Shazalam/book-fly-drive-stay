  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
      ...
      <div className="relative z-10 px-6 max-w-6xl mx-auto text-center">
        ...
        >
          <span className="block text-4xl md:text-6xl lg:text-7xl font-extrabold text-white drop-shadow-2xl">
            Feel the
          </span>
          <span className="block text-4xl md:text-6xl lg:text-7xl font-extrabold mt-2 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-shift bg-300%">
            Premium Drive
          </span>
        </h1>
        ...
        {/* Subheading */}
        <p
          className={`text-xl md:text-2xl lg:text-3xl mb-12 text-blue-100 max-w-4xl mx-auto leading-relaxed font-light transition-all duration-1000 delay-200 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
