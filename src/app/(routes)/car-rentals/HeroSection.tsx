...
//   const handleCarRentalSubmit = (values: CarRentalFormValues) => {
//     console.log("Form submitted:", values);
//     // Call your API here
//     // await fetch("/api/cars/search", { method: "POST", body: JSON.stringify(values) });
//   };
...
//         {/* Main Heading */}
//         <h1
//           className={`mb-6 leading-tight transition-all duration-1000 delay-100 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
//         >
...
//         </h1>
//         <p
//           className={`text-xl sm:text-2xl md:text-3xl mb-12 text-blue-100 max-w-4xl mx-auto leading-relaxed font-light transition-all duration-1000 delay-200 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
//         >
...
//         <div className="w-6xl h-3.5 bg-amber-300 ">
//                  <CarRentalForm onSubmit={handleCarRentalSubmit} isMobile={false} />
//         </div>

//         {/* Contact Text */}
//         <p
//           className={`text-lg text-blue-100 font-medium transition-all duration-1000 delay-300 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
//             }`}
//         >
