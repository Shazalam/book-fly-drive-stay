...
import CarSearchFilters from '@/app/(components)/cars/CarSearchFilters';
import CarListingCard from '@/app/(components)/cars/CarListingCard';
import MobileDrawer from '@/app/(components)/common/MobileDrawer';
    ...
    return (
        <div className="min-h-screen bg-gray-50">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <Button
                                        ...
                                        iconLeft={<FaFilter className="w-4 h-4" />}
                                        variant="outline"
                                        className="lg:hidden"
                                    >
                                     Sort & Filters
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
                                    <p className="text-gray-600 text-sm sm:hidden">
                                        JFK Airport • Nov 9, 10:30am - Nov 10, 10:30am
                                    </p>
                                    ...
                                    <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-normal">
                                        ...
                                        <select
                                            value={sortBy}
                                            onChange={(e) => setSortBy(e.target.value)}
                                            className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent flex-1 sm:flex-none"
                                        >
                                            <option value="recommended">Recommended</option>
                                            <option value="price-low">Price: Low to High</option>
                                            <option value="price-high">Price: High to Low</option>
            ...
            >
                ...
                {/* Apply Filters Button at bottom for mobile */}
