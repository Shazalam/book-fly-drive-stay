...
// Navigation Component with usePathname
const Navigation = () => {
        ...
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <Suspense fallback={
                <nav className="flex space-x-8">
                  <div className="px-3 py-2 rounded-md text-sm font-medium text-gray-500">Sign In</div>
                  <div className="px-3 py-2 rounded-md text-sm font-medium text-gray-500">Create Account</div>
                  <div className="px-3 py-2 rounded-md text-sm font-medium text-gray-500">Find My Trip</div>
                </nav>
              }>
                <Navigation />
              </Suspense>
