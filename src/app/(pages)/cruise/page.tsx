    ...
    const testimonials = [
        {
            id: 1,
            name: 'Sarah Johnson',
            comment: 'The Caribbean cruise was absolutely amazing! The staff went above and beyond to make our vacation special.',
            rating: 5
        },
        {
            id: 2,
            name: 'Michael Chen',
            comment: 'Alaskan adventure was a once-in-a-lifetime experience. Saw whales right from our balcony!',
            rating: 5
        },
        {
            id: 3,
            name: 'Emily Rodriguez',
            comment: 'Perfect family vacation. The kids loved the pools and activities while we enjoyed the spa and dining.',
            rating: 4
        }
    ];
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Book luxury cruise deals at the lowest prices. Secure and easy booking process." />
            </Head>
            ...
            <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
                ...
                <section className="bg-blue-600 text-white py-16">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose BookFlyDriveStay for Your Cruise?</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center p-6 bg-white/10 rounded-xl">
                                ...
                                <p className="text-blue-100">We guarantee the lowest prices on all our cruise packages or we'll match the difference.</p>
                            </div>
                            <div className="text-center p-6 bg-white/10 rounded-xl">
                                <div className="bg-white/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-blue-100">Our cruise experts are available round the clock to assist you with any questions or changes.</p>
                            </div>
                            <div className="text-center p-6 bg-white/10 rounded-xl">
                                <div className="bg-white/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-blue-100">Get special onboard credits, cabin upgrades, and amenities not available when booking directly.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="container mx-auto px-4 py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">Don't just take our word for it - hear from travelers who've sailed with us</p>
                    </div>
                ...
                <section className="bg-amber-500 py-16">
                    <div className="container mx-auto px-4 text-center">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Set Sail?</h2>
                        <p className="text-xl text-white mb-8 max-w-2xl mx-auto">Contact our cruise specialists today to find the perfect vacation for you</p>
